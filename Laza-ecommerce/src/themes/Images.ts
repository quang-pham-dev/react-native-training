const IMAGES = {
  ...
  iconMenuOpen: require('assets/images/icons/menu-open.png'),
  ...
  iconHeartLiked: require('assets/images/icons/heart-liked.png'),
  ...
  iconBagDrawer: require('assets/images/icons/bag-drawer.png'),
  iconHeartDrawer: require('assets/images/icons/heart-drawer.png'),
  iconWalletDrawer: require('assets/images/icons/wallet-drawer.png'),
  iconClock: require('assets/images/icons/clock.png'),
  reviewerAvatar: require('assets/images/icons/reviewer.png'),
  ratingStart: require('assets/images/icons/start-rate.png'),
